    ...
    <div className="custom-pack">
            <a href="https://sailsubham.com/students-tour-package">
              ...
              <div className="h-48 overflow-hidden relative">
                <img
                  src="src/assets/image/students.jpg"
            ...
            <div className="content">
              <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold font-pri_head mb-6 text-primary">SPECIAL STUDENTS PACKAGE</h3>
            </div>


            
            <p className="text:xl pack-description w-70">Limited Time Offer! Student Tours for the Next <b>6 Months –  Just ₹9,999</b></p>
          </div>
