      ...
      <div className="relative z-10 px-6 sm:px-[6vw]">
        ...
        <div className="mt-4 flex flex-col lg:flex-row justify-between items-center space-y-5 lg:space-y-0">
          ...
          <div className="flex lg:flex-row flex-col items-center gap-2">
            <p className="text-sm font-pri_para opacity-80">&copy; Copyright {new Date().getFullYear()} Subham | Design by</p>
            <Link to="https://dmedia.in/" className="underline font-bold hover:text-primary font-pri_head text-sm">
              DMedia
            </Link>
          </div>
